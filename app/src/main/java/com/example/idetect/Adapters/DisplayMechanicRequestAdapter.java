...
public class DisplayMechanicRequestAdapter extends RecyclerView.Adapter<DisplayMechanicRequestAdapter.ViewHolder> {

    private Context context;
    private List<ServCentCustomerService> modelList;
    String mechName, mechAddress, mechBirth, mechSkills, mechGender;

    public DisplayMechanicRequestAdapter(Context context, List<ServCentCustomerService> modelList) {
    ...
    @NonNull
    @Override
    public DisplayMechanicRequestAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.custom_list_mechanic_request, parent, false);
        return new DisplayMechanicRequestAdapter.ViewHolder(view);
    }


    @Override
    public void onBindViewHolder(@NonNull DisplayMechanicRequestAdapter.ViewHolder holder, int position) {
        ...
        holder.shopApprove.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                FirebaseDatabase.getInstance().getReference().child("MECHANIC_REQUEST").child(model.getKey()).updateChildren(hashMap);
        ...
        holder.shopCancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                FirebaseDatabase.getInstance().getReference().child("MECHANIC_REQUEST").child(model.getKey()).removeValue();
                FirebaseDatabase.getInstance().getReference().child("USERS").child(FirebaseAuth.getInstance().getCurrentUser().getUid())
                        .addValueEventListener(new ValueEventListener() {
                            @Override
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
